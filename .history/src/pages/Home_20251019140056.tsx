...
// ✅ تغییر ۱: وارد کردن عکس محلی
import myImage from '/image/myimage.jpg';

export default function Home() {
  // اگر از TypeScript استفاده می‌کنید، باید مطمئن شوید که BlogPost تعریف شده است
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/portfolio"
                  className="inline-flex items-center px-5 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all"
                >
                  View My Work
